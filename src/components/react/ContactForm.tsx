...
function ContactForm() {
  ...
  return (
      <>
          ...
          <label htmlFor="name" className={"hidden"}>Name</label><input type="text" id="name" name="name" placeholder="Name" className={"block w-[80%] ml-auto mr-auto min-w-[60%] p-3 rounded-lg resize-y font-mono bg-[#222225] text-white border border-white/10"}/>
          <br/><br/>
          <label htmlFor="inquiry" className={"hidden"}>Inquiry</label><textarea id="inquiry" name="inquiry" placeholder="Inquiry" spellCheck="true" rows={rows} className={"block w-[80%] ml-auto mr-auto min-w-[60%] p-3 bg-[#222225] rounded-lg resize-y font-mono text-white border border-white/10"}></textarea>
