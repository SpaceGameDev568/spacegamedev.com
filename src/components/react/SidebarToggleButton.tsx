...
function SidebarToggleButton() {
  ...
  return (
      <>
          <button className={"material-symbols-rounded aspect-square h-[calc(100%-0.5rem)] mt-1 ml-1 hover:bg-blue-500 duration-300 rounded-lg text-white bg-transparent select-none hover:ring-4 hover:ring-blue-500/50 cursor-pointer border-[1px] border-white/10"} id={"material-icon"} title={"Toggle Sidebar"} onClick={toggleSidebar}>
